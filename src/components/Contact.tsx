          ...
          <div className="lg:w-1/2">
            <div className="mb-8">
              ...
              <div className="space-y-3 text-gray-700">
                <p>
                  <span className="font-semibold">العنوان:</span> المملكة العربية السعودية، الرياض، طريق الملك فهد
                </p>
                <p>
                  <span className="font-semibold">الهاتف:</span> +966 123 456 789
                </p>
                <p>
                  <span className="font-semibold">البريد الإلكتروني:</span> info@me-caravan.com
                </p>
                <p>
                  <span className="font-semibold">ساعات العمل:</span> الأحد - الخميس: 9 صباحًا - 5 مساءً
                </p>
              </div>
            </div>
