      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-gray-600">
            نقدم مجموعة متنوعة من العربات المتنقلة المصممة لتلبية احتياجاتك الخاصة
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product) => (
            <div key={product.id} className="bg-white rounded-lg overflow-hidden shadow-md transform transition-transform duration-300 hover:shadow-xl hover:-translate-y-1">
