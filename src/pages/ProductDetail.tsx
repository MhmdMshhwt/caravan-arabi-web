...
const ProductDetail = () => {
  ...
  const productsData = {
    caravans: {
      ...
      longDescription:
        "نقدم تشكيلة واسعة من الكرفانات المتنقلة المصممة وفقاً لأعلى معايير الجودة والسلامة. تتميز كرفاناتنا بتصاميم عصرية مريحة وعملية، مع إمكانية التخصيص حسب احتياجات العميل.",
    ...
    "fixed-units": {
      ...
      longDescription:
        "وحداتنا الثابتة مصممة لتوفير حلول دائمة وموثوقة للاستخدامات المختلفة. تتميز بالمتانة والجودة العالية مع تصاميم حديثة تناسب مختلف الاحتياجات.",
    ...
    "mobile-toilets": {
      ...
      longDescription:
        "حماماتنا المتنقلة مصممة لتوفير حلول صحية مريحة ونظيفة للمواقع المؤقتة والفعاليات. تتميز بسهولة النقل والتركيب مع الحفاظ على أعلى معايير النظافة.",
      ...
      features: ["نظافة عالية", "سهولة النقل", "مجهز بالكامل", "صديق للبيئة"],
    },
    "ready-made-homes": {
      title: "منازل جاهزه",
      description:
      ...
      longDescription:
        "منازلنا الجاهزة توفر حلول سكن سريعة وعالية الجودة. مصممة بأحدث التقنيات وتأتي مجهزة بالكامل لتوفير الراحة والأمان لسكانها.",
    ...
    "guard-booths": {
      ...
      longDescription:
        "أكشاك الحراسة لدينا مصممة لتوفير بيئة عمل مريحة وآمنة لموظفي الأمن. مجهزة بأحدث التقنيات وأنظمة المراقبة للحصول على أقصى درجات الحماية.",
      mainImage: guardBoothsImg,
      images: [guardBoothsImg],
      specifications: [
    ...
    "mobile-fixed-restaurants": {
      ...
      longDescription:
        "مطاعمنا المتنقلة والثابتة مصممة لتلبية احتياجات قطاع الأغذية بأعلى المعايير. مجهزة بمطابخ احترافية وأنظمة سلامة غذائية متكاملة.",
      mainImage: resturantsImg,
      images: [resturantsImg],
      specifications: [
    ...
    "metal-fences": {
      ...
      longDescription:
        "أسوارنا المعدنية مصنوعة من أجود المواد لضمان الحماية والمتانة. متوفرة بتصاميم مختلفة لتناسب جميع الاحتياجات السكنية والتجارية.",
    ...
    "cars-umbrellas": {
      ...
      longDescription:
        "مظلات السيارات لدينا توفر حماية فعالة للمركبات من أشعة الشمس والأمطار. مصنوعة من مواد عالية الجودة ومقاومة للعوامل الجوية.",
    ...
    containers: {
      ...
      longDescription:
        "حاوياتنا متعددة الاستخدامات وتوفر حلول تخزين مثالية للاستخدامات المختلفة. مصنوعة من مواد عالية الجودة لضمان الحماية والمتانة.",
    ...
    "metal-hangars": {
      ...
      longDescription:
        "هناجرنا المعدنية توفر مساحات واسعة ومتينة للاستخدامات الصناعية والتخزين. مصممة لتحمل الأحمال الثقيلة والظروف الجوية القاسية.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm mb-6 sticky top-24">
                ...
                <a href="/contact">
                  <button className="gold-button w-full text-center">
                    طلب عرض سعر
                  </button>
                </a>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  ...
                  <div className="space-y-2">
                    <p className="flex items-center">
                      ...
                      <span>هاتف: 201108142801+</span>
                    </p>
                    <p className="flex items-center">
                      <span className="inline-block w-4 h-4 bg-gold mr-2"></span>
                      <span>واتساب: 201108142801+</span>
                    </p>
                    <p className="flex items-center">
                      <span className="inline-block w-4 h-4 bg-gold mr-2"></span>
                      <span>البريد: nile0caravans@gmail.com</span>
                    </p>
                  </div>
                </div>
              </div>
