      ...
      <div className="py-12">
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <div className="lg:w-1/2">
            <img 
              src="https://images.unsplash.com/photo-1565361893317-47e84f6674cd?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" 
              alt="ME Caravan Team" 
          ...
          <div className="lg:w-1/2">
            <h3 className="text-2xl font-bold mb-4">شركة رائدة في تصنيع العربات المتنقلة</h3>
            <p className="mb-4 text-lg">
              شركة ME Caravan هي شركة متخصصة في تصنيع وتوريد العربات المتنقلة بمختلف أنواعها وأحجامها، تأسست الشركة عام 2010 على يد مجموعة من المهندسين ذوي الخبرة والكفاءة العالية.
            </p>
            <p className="mb-4 text-lg">
              نحن نفتخر بتقديم منتجات ذات جودة عالية تلبي احتياجات عملائنا في مختلف القطاعات، سواء كانت للاستخدامات التجارية أو السكنية أو الترفيهية.
            </p>
            <p className="mb-4 text-lg">
              تتميز منتجاتنا بالمتانة والجودة العالية والتصميم المبتكر، كما نقدم خدمات ما بعد البيع لضمان رضا العملاء ومساعدتهم في الحصول على أفضل استفادة من منتجاتنا.
            </p>
        ...
        <div className="mt-16 bg-gray-50 p-8 rounded-lg">
          <h3 className="text-2xl font-bold mb-6 text-center">رؤيتنا ومهمتنا</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <h4 className="text-xl font-bold mb-3 text-gold">رؤيتنا</h4>
              <p>أن نكون الرواد في مجال تصنيع وتوريد العربات المتنقلة في المملكة العربية السعودية والشرق الأوسط، من خلال تقديم منتجات مبتكرة وعالية الجودة تلبي احتياجات العملاء وتتجاوز توقعاتهم.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <h4 className="text-xl font-bold mb-3 text-gold">مهمتنا</h4>
              <p>توفير حلول متنقلة متكاملة وعالية الجودة تناسب مختلف الاحتياجات، مع التركيز على الابتكار والاستدامة والتميز في خدمة العملاء، وذلك من خلال فريق عمل محترف ومتخصص.</p>
            </div>
          </div>
        </div>
